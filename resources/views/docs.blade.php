                ...
                <div class="px-8 sm:px-16 lg:px-24">
                    <div class="flex justify-end">
                        <div class="max-w-screen-lg flex flex-col items-end transition-colors dark:border-gray-700 lg:mt-8 lg:flex-row-reverse">
                            <div class="fixed top-8 hidden right-36 lg:flex items-center justify-center">
                        ...
                        <!-- Settings Dropdown -->
                        <div class="hidden fixed top-7 right-25 lg:flex items-center justify-center">
                            <x-dropdown align="right" width="32">
                                <x-slot name="trigger">
                                    
                                        <div class=""><img 
                                            class="w-8 h-8 shrink-0 border rounded-full transition-all duration-300 lg:w-12 lg:h-12"
